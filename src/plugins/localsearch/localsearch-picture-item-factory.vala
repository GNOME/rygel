 ...
 */
public class Rygel.LocalSearch.PictureItemFactory : ItemFactory {
    ...
    private const string GRAPH_IRI = "http://tracker.api.gnome.org/ontology/v3/tracker#Pictures";
    ...
    public PictureItemFactory () {
        ...
        base (CATEGORY, CATEGORY_IRI, GRAPH, GRAPH_IRI, PhotoItem.UPNP_CLASS, upload_folder);
